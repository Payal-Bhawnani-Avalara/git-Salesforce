 ...
 * Parameter Definition: component pass from controller as parameter refrence
 * Purpose: this method is used to get the First date of the year and assign the value into "yearLastDate" variable for component use
 **************************************************************************/        
     getFirstDate : function(component) {
        
        var action = component.get("c.FirstDate");
        action.setCallback(this, function(a) {
            console.log(a.getReturnValue());
            component.set("v.yearFirstDate", a.getReturnValue());
        });
        $A.enqueueAction(action);
 ...
 * Parameter Definition: component pass from controller as parameter refrence
 * Purpose: this method is used to get the yesterday date and assign the value into "yesterdayDate" variable for component use
 **************************************************************************/        
    getyesterdayDate : function(component) {
        
        var action = component.get("c.yesterdayDate");
        action.setCallback(this, function(a) {
            console.log(a.getReturnValue());
            component.set("v.yesterdayDate", a.getReturnValue());
        });
        $A.enqueueAction(action);
 ...
 * Purpose: this method is used to get the yesterday date and assign the value into "yesterdayDate" variable for component use
 **************************************************************************/        
    gettomorrowDate : function(component) {
        
        var action = component.get("c.tomorrowDate");
        action.setCallback(this, function(a) {
            console.log(a.getReturnValue());
            component.set("v.tomorrowDate", a.getReturnValue());
        });
        $A.enqueueAction(action);
...
/***************************  getFiltersLabel function ***************************
 * Parameter Definition: component pass from controller as parameter refrence
 * Purpose: this method is used to get the current filterType label and assign the value into "currentDate" variable for component use
 **************************************************************************/        
       getFiltersLabel : function(component,filterType) {
        
          var mapObject= component.get('v.FilterLabelsMap');
           
           var label = mapObject[filterType];
       
            component.set("v.filtersLabel",label);
