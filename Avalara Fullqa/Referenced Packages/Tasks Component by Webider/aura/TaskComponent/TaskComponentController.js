...
({
    doInit : function(component,event,helper) {
        ...
        helper.callToServer(
            ...
            function(response) {
                if(response){
                    ...
                    console.log('SelectedRecord type '+jsonObject[0].recordTypeId);         
                }
            }, 
            {objName: 'Task'}
        ); 
        ...
        component.set("v.filterType",'AllOpen');
        
        var filterType = component.get("v.filterType"); 
        helper.getFiltersLabel(component,filterType);
        ...
        //Call First date from helper      
        helper.getFirstDate(component);  
        ...
        //Call yesterday date from helper     
        helper.getyesterdayDate(component);       
        
        //Call tomorrow date from helper     
        helper.gettomorrowDate(component);  
 ...
 ****************************************************************/
    ...
    switchStatics : function(component,event,helper){
        ...
        component.find("selection").set("v.value", selectVal);
        var filterType = component.get("v.filterType"); 
        helper.getFiltersLabel(component,filterType); 
        var page = 1
        var recordToDisply = component.get("v.maxLim")+'';                       
 ...
 */
    ...
    newTask : function(component, event) {            
        ...
        if(total>1){                
            ...
            /*
                 var currentLocation = document.documentURI;
                var evt = $A.get("e.force:navigateToComponent");
                evt.setParams({
                    componentDef: "ActivityComPro:WebiderRecordTypeComponent",
                    componentAttributes: {  "objType": "Task","OUrl": currentLocation
                                          // Attributes here.
                                         },
                    resetHistory : true,
                });
 ...
 ****************************************************************/
    showModal_tasks : function(component, event, helper) {
        document.getElementById("modaldialog_tasks").style.display = "block";
        document.getElementById("dialogbackdrop_tasks").style.display = "block";
    },
    /********************* hideModal() function *******************
 * This function takes the component name, the event action and helper class reference
 ...
 ****************************************************************/
    ...
    hideModal_tasks : function(component,event, helper){
        document.getElementById("modaldialog_tasks").style.display = "none" ;
        document.getElementById("dialogbackdrop_tasks").style.display = "none" ;
    },
