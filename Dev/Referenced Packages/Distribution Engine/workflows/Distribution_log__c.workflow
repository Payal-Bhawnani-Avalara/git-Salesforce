...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Distribution_Engine_Email_Notification_v2</fullName>
        ...
        <template>Distribution_Engine_Templates/Distribution_Engine_Notification_v2</template>
    </alerts>
    <rules>
        <fullName>Distribution Engine Notification</fullName>
        <actions>
            <name>Distribution_Engine_Email_Notification_v2</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
